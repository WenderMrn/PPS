...
public class UsuarioFacade {
	...
	public void adicionarEvento(String nome,String nomeContato,String dataInicial,String dataFinal){
		Evento e = new Evento(dataInicial,dataFinal);	
		e.setNome(nome);
		e.setNomeContato(nomeContato);
		this.u.adicionarEvento(e);
	}
	
	public void adicionarEvento(String nome,String nomeContato,List<DiasSemana> dias){
		
		Evento e = new Evento(dias);	
		e.setNome(nome);
		e.setNomeContato(nomeContato);
		this.u.adicionarEvento(e);
	}
	...
	public Evento localizarEventoDataInicio(String data){
		return this.u.localizarEventoDataInicio(data);
	}
	public Evento localizarEventoDataFim(String data){
		return this.u.localizarEventoDataFim(data);
	}
	// localizar sala por: 
